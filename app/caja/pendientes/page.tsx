  ...
  return (
    <div className="space-y-4 p-3 sm:p-6">
      ...
      <div className="rounded-xl border border-blue-200 bg-blue-50 p-3 text-xs text-blue-800 flex gap-2">
        ...
        <span>Al cobrar un préstamo express, el interés generado se registra automáticamente como ingreso en la caja común y se distribuye entre los inversores.</span>
      </div>
